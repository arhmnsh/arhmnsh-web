...
.poem-navigation { display: flex; flex-wrap: wrap; gap: 8px; }
...
.poem-byline { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 12px 24px; margin-top: 22px; color: hsl(var(--muted-foreground)); font-size: 13px; }
.poem-byline p { margin: 0; }
...
.poem-recordings { padding-top: 12px; }
